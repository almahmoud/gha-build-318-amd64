...
trying URL 'https://cloud.r-project.org/src/contrib/gtable_0.3.4.tar.gz'
...
trying URL 'https://cloud.r-project.org/src/contrib/ggplot2_3.4.3.tar.gz'
Content type 'application/x-gzip' length 2190947 bytes (2.1 MB)
==================================================
downloaded 2.1 MB
...
trying URL 'https://bioconductor.org/packages/3.18/bioc/src/contrib/gemma.R_1.3.2.tar.gz'
Content type 'application/x-gzip' length 1611664 bytes (1.5 MB)
==================================================
downloaded 1.5 MB
...
installing to /tmp/tmp/built/00LOCK-isoband/00new/isoband/libs
** R
** inst
** byte-compile and prepare package for lazy loading
** help
...
** testing if installed package keeps a record of temporary installation path
* creating tarball
packaged installation of ‘gemma.R’ as ‘gemma.R_1.3.2_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (gemma.R)
...
The downloaded source packages are in
	‘/tmp/Rtmpht3yMn/downloaded_packages’
Old packages: 'GenomeInfoDb', 'GenomicFeatures', 'KernSmooth', 'Matrix',
