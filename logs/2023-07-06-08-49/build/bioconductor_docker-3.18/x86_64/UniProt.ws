...
trying URL 'https://bioconductor.org/packages/3.18/bioc/src/contrib/UniProt.ws_2.41.3.tar.gz'
Content type 'application/x-gzip' length 241802 bytes (236 KB)
==================================================
downloaded 236 KB
...
** testing if installed package keeps a record of temporary installation path
* creating tarball
packaged installation of ‘UniProt.ws’ as ‘UniProt.ws_2.41.3_R_x86_64-pc-linux-gnu.tar.gz’
* DONE (UniProt.ws)

The downloaded source packages are in
	‘/tmp/RtmpNKym1W/downloaded_packages’
